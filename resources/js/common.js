...
=========================================================================================================== */
	...
	$('.mo-hide .search-area input').focus(function(){
		$(this).closest('.search-area').find('.lst').show();		
	});
	$('.mo-hide .search-area input').blur(function(){
	...
	/* 모바일 검색, 알림 레이어 */
	$('.util.pc-hide > li > a').click(function(){
		if($(this).hasClass('on')){
			$(this).removeClass('on').closest('li').find('.h-layer').stop().slideUp();
			$('.header').removeClass('on');
		}else{
			$(this).addClass('on').closest('li').find('.h-layer').stop().slideDown();			
			$('.header').addClass('on');
		}		
	});
	$('.btn-prev').click(function(){
		$(this).removeClass('on').closest('li').find('.h-layer').stop().slideUp();
		$(this).removeClass('on').closest('li').find('.btn-search.mo').removeClass('on');
		$('.header').removeClass('on');
	});
...
$('.btn-gnb').click(function(){
	if($(this).hasClass('active')){			
		...
		$('.gnb-layer').removeClass('on');
		$('html, body').removeAttr('style');			
	}else{	
		$(this).addClass('active');
		$('.gnb-layer').addClass('on');			
...
$('.btn-set').click(function(){		
	if($(this).hasClass('on')){
		$(this).removeClass('on').find('.switch').text('off');
		
	}else{
		$(this).addClass('on').find('.switch').text('on');
	}		
});
...
//리플 더보기레이어
$('.btn-more.layer').click(function(){
	if($(this).hasClass('on')){
		$(this).removeClass('on').next('.btn-layer-list').removeClass('on');
	}else{
		$(this).addClass('on').next('.btn-layer-list').addClass('on');
	}
});
...
/*정렬*/
$('.sort-area .btn-tab').click(function(){
	var idx = $(this).index();
	console.log(idx);
	$(this).addClass('on').siblings().removeClass('on');
});
...
/* faq아코디언 */
$(document).on('click', '.faq-list .item .faq-tit', function(){
	var $item = $(this).closest('.item');	
	$('.faq-layer').removeClass('on').slideUp(200);
	if($item.hasClass('on')){
		$item.removeClass('on').find('.faq-layer').removeClass('on').slideUp(200);
	}else{	
